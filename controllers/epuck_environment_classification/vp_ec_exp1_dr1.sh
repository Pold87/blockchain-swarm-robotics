...
resultsdir="~/working/$dirprefix-results/"
# JOBDIR (final destination of the .err and .out files of the job)
jobdir="~/working/$dirprefix-job_outputs/"
# SCRIPTSDIR (final destination of the script of the job)
scriptsdir="~/working/$dirprefix-scripts/"
# THECOMMAND
argos_template="/home/volker/Downloads/code/code/argos_simulations/Epuck/experiments/c_epuck_environment_classification.argos"
command="argos3"
