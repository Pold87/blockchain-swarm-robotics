...
BLOCKCHAINPATH='/home/vstrobel/eth_data_para1/data' # always without '/' at the end!!
MINERID=120
NUMROBOTS=(20) 
REPETITIONS=15
DECISIONRULE=1
...
MAPPINGPATH='/home/vstrobel/Documents/argdavide/experiments/config1.txt'
CHANGEDIFFIULTY=""
USEDNODES=(0 1) # TODO: CHANGE BACK !!!
BASEPORT=34000
DATADIR="data/experiment1_decision${DECISIONRULE}-bg/"
...
for k in "${NUMROBOTS[@]}"; do
	...
	# Create template
	sed -e "s|BASEDIR|$BASEDIR|g" -e "s|DATADIR|$DATADIR|g" -e "s|RADIX|$RADIX|g" -e "s|NUMROBOTS|$k|g" -e "s|R0|$R0|g" -e "s|B0|$B0|g" -e "s|PERCENT_BLUE|$PERCENT_BLACK|g" -e "s|PERCENT_RED|$PERCENT_WHITE|g" -e "s|DECISIONRULE|$DECISIONRULE|g" -e "s|USEMULTIPLENODES|$USEMULTIPLENODES|g" -e "s|REPETITIONS|$REPETITIONS|g" -e "s|MININGDIFF|$MININGDIFF|g" -e "s|MINERNODE|$MINERNODE|g" -e "s|MINERID|$MINERID|g" -e "s|BASEPORT|$BASEPORT|g" -e "s|USEBACKGROUNDGETHCALLS|$USEBACKGROUNDGETHCALLS|g" -e "s|BLOCKCHAINPATH|$BLOCKCHAINPATH|g" -e "s|MAPPINGPATH|$MAPPINGPATH|g" $TEMPLATE > $OUTFILE
