...
#pdf("/home/volker/Dropbox/mypapers/technical_report_collective/img/exit_prob.pdf")
...
plotCI(df$difficulties, df$E.Ns, ui=df$E.UI, li=df$E.LI,
       xlab="Percentage white cells", ylab="Exit probability",
       pch=1, col=tol4qualitative[1], ylim=c(0, 1), font.lab=2, cex=2,
     lty=2
     )
lines(df$difficulties, df$E.Ns,
       col=tol4qualitative[1:1],
      )
