...
for i in `seq 1 $REPETITIONS`; do
    ...
    # Create template
sed -e "s|BASEDIR|$BASEDIR|g" -e "s|RADIX|$RADIX_$i|g" -e "s|NUMROBOTS|$NUMROBOTS|g" -e "s|R0|$R0|g" -e "s|B0|$B0|g" -e "s|PERCENT_RED|$PERCENT_RED|g" -e "s|PERCENT_BLUE|$PERCENT_BLUE|g" $TEMPLATE > $OUTFILE
